...
- Bank Debt at 3x EBITDA and senior debt at 1x give a total of 4x EBITDA multiple which is a conservaitve estimate. 
- EBITDA margin expansion of 0.05% was chosen for base case as it is margins are already thin and operations are already high optimised.
- Equity Value was calculated by the share price of 2.92 multiplied by shares issued of 1,091,553.7660.
- Assuming standard EBITDA multiple of 10x is mantained at entry and exit.

For differences in bullish/base/bear cases, these values were changed:
Bull:
Revenue Growth= 6%
EBTIDA Margin = 0.1%
Exit multiple = 8x
...
## Template
LBO template and guide taken from: https://www.youtube.com/watch?v=Q7qNxmxkm8o
